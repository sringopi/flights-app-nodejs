-- Create the flights database tables for ColumnStore (no primary keys or indexes)
USE flights;
...
INSERT INTO flights (year, month, day, day_of_week, fl_date, carrier, tail_num, fl_num, origin, dest, crs_dep_time, dep_time, dep_delay, cancelled, diverted, distance) VALUES 
